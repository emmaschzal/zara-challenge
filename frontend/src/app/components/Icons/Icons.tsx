export function CartActive({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CartInactive({ size = 24, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LeftArrow({ size = 14, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function Logo({ size = 77, color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={(size * 30) / 77}
    ...
    >
      ...
      />
      <path
        d="M27.2939 13.1445V16.2878H12.7225V13.1445H27.2939Z"
        fill={color}
      />
      <path
