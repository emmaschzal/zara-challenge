...
export default function ProductPage() {
  ...
  const handleAddToCart = () => {
    ...
    const selectedImage = colorOptions.find((c) => c.name === selectedColorValue)?.imageUrl;
    ...
    const cartItem: CartItem = {
      ...
      priceAtAddTime:
        storageOptions.find((s) => s.capacity === selectedStorageValue)?.price ||
        product.basePrice,
    };
  ...
  const selectedStoragePrice = storageOptions.find((s) => s.capacity === selectedStorage)?.price;
